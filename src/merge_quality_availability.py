...
filtra sólo la línea configurada (columna `linea`), pivota availability y crea un Parquet único listo para feature engineering.
"""
import pandas as pd
...
CAUSE_MAP = {
    "M01": "Mantenimiento_Averia", "M02": "Mantenimiento_Ajuste", "M03": "Mantenimiento_Servicios",
    "M04": "Mantenimiento_Programado", "M05": "Mantenimiento_Planeado", "M06": "Mantenimiento_AjusteFinalCambioFormato",
    "M09": "Mantenimiento_EquipoRelacionado",
    "PD01": "Planeacion_CambioProgramacion", "PD02": "Planeacion_FaltaInsumo",
    "L01": "Logistica_SinMateriaPrima", "L02": "Logistica_SinEspacio",
    "P01": "Produccion_ParoOperativo", "P02": "Produccion_Convencional", "P03": "Produccion_Limpieza",
    "P04": "Produccion_CambioDestino", "P05": "Produccion_SinSistemaWMS", "P06": "Produccion_Capacitacion",
    "P07": "Produccion_SinLicor", "P08": "Produccion_NivelLlenado",
    "CO1": "Calidad_Embalaje", "CO2": "Calidad_Botella", "CO3": "Calidad_Tapa",
    "CO4": "Calidad_Etiqueta", "CO5": "Calidad_ParametrosFueraRango",
    "-": "Otros", "001": "Falla_Comunicacion",
}
...
def merge_and_clean():
    ...
    # 5. Seleccionar columnas útiles (incluye 'linea')
    q = q[["_time", "linea", "_value", "real_velocity", "product_id", "device_id"]]
    ...
    # 8. Merge asof: unir calidad con availability más cercana
